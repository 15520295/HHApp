//package com.example.huydaoduc.hieu.chi.hhapp.CustomView;
//
...
//        int progressColour;
//        try {
//            backgroundColour = ta.getColor(R.styleable.CustomProgressBar_backgroundColour, 0);
//            progressColour = ta.getColor(R.styleable.CustomProgressBar_progressColour, 0);
//            int defaultDuration = context.getResources().getInteger(android.R.integer.config_mediumAnimTime);
//            duration = ta.getInteger(R.styleable.CustomProgressBar_duration, defaultDuration);
//        } finally {
//            ta.recycle();
//        }
